...
<?php 
	...
	$sql="SELECT project.* FROM project ORDER BY project.projectID";
	...
	<div class="container animated fadeInRightBig">
	 <div class="demo-card-wide mdl-card mdl-shadow--2dp" style="margin-right:20px;width: 100%;margin: auto">
	  ...
	  <div class="mdl-card__actions mdl-card--border">
		<a href="admin/saveRecord.php?projectID=<?php echo $newArray['projectID']; ?>" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">
		  Edit Project
		</a>
	  </div>
