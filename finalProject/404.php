...
<html lang="en">
  <head>
   <?php
    ...
    <title>404 | SAMAN GAMAGE CIVIL ENGINEERS AND CONTRACTORS</title>
...
<!-- Ending the Navbar -->  
  <main class="mdl-layout__content">
	 <div class="container animated fadeIn" style="text-align: center;color: #FFF;">
	  	...
	  	<p style="display: block; font-size: 50px;margin-top: 30px;" class="hidden-xs hidden-md hidden-sm">
	  	ERROR 404 PAGE NOT FOUND</p>
	  	<p style="display: block; font-size: 30px;margin-top: 30px;">Please Return to Home Page</p>
